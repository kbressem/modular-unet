...
__all__ = ['ConvLayer', 'DropConnect', 'SqueezeExpand', 'MBConvBlock', 'SpatialAttention', 'UnetBlock', 'BasicResBlock']
...
class UnetBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn = norm(s_c)
        if spatial_attention: self.sa = SpatialAttention(up_c, s_c)
